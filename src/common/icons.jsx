...
export function KaggleIcon({ size = 20, className = "" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M18.825 23.859c-.022.092-.117.141-.281.141h-3.139c-.187 0-.351-.082-.492-.248l-5.178-6.589-1.448 1.374v5.111c0 .235-.117.352-.351.352H5.505c-.236 0-.354-.117-.354-.352V.353c0-.233.118-.353.354-.353h2.431c.234 0 .351.12.351.353v14.343l6.203-6.272c.165-.165.33-.246.495-.246h3.239c.144 0 .236.06.285.18l.046.149c0 .069-.025.142-.094.211l-6.156 5.799 6.561 8.395c.094.117.14.21.14.282l-.181.165z" />
    </svg>
  );
}
